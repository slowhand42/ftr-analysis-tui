            ...
            for update in updates:
                ...
                if cell_key in cell_targets:
                    return {
                        ...
                        'failed_count': 1,
                        'error_message': (
                            f"Conflict: Multiple edits target the same cell "
                            f"(cluster={update['cluster']}, "
                            f"index={update['constraint_index']}, "
                            f"column={update['column']})"
                        )
                    }
            ...
            try:
                for update in updates:
                    ...
                    if success:
                        ...
                        self._edit_history = deque(list(self._edit_history)[
                                                   :backup_history_size], maxlen=1000)
                        return {
                            'success': False,
                            'applied_count': 0,
                            'failed_count': 1,
